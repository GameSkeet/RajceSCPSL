...
namespace RajceUI.UI
{
    public static partial class UIElements
    {
        ...
        public static Element List<TList>(
            ...
            where TList : IList
            => List(label, Binder.Binder.Create(readValue, writeValue), createItemElement, option);
        ...
        public static Element ListReadOnly<TList>(
            ...
            where TList : IList
        {
            var binder = Binder.Binder.Create(readValue, null);
        ...
        private static ListViewOption? CalcDefaultOptionOf(LambdaExpression expression)
            => null; /*OLD: ExpressionUtility.GetAttribute<NonReorderableAttribute>(expression) != null
