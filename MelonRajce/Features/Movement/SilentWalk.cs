...
{
    internal class SilentWalk : Feature
    {
        ...
        public override string Name { get; protected set; } = "Silent Walk";
        public override string Description { get; protected set; } = "Your footsteps wont be heard";
